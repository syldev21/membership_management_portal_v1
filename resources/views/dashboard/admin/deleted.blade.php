<div class="row">
    <h3 class="mb-2">Deleted Members at Church Level</h3>
    <div class="row">
        <div class="col-lg-2">
            <div class="card">
                <div class="stat-widget-one">
                    ...
                    <div class="stat-content dib">
                        @php
                            $deleted_stage1 = $stagecounts['stage1_counts']['deleted']??'';
                        @endphp
                        ...
                        <div class="stat-digit">{{$deleted_stage1}}</div>
                    </div>
                </div>
            </div>
        </div>
...
<div class="table table-responsive m-2" id="main">
    <h3 class="mb-2">Deleted Members at Cell Group Level</h3>
