...
<head>
    ...
    <title>@yield('title')-VOSH Church Buru Buru</title>
...
<body class="bg-info" style="background-image: url('{{ asset('images/slide-view/_MG_1432.JPG') }}'); background-size: cover; background-repeat: no-repeat;" id="image_head">
